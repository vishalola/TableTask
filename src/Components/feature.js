export default function Feature(props){
    ...
    return (
        <li class="outlin flex space-x-4">
            <svg class={`h-5 w-5 flex-none ${props.popular?'text-blue-500':'text-black'}`} viewBox="0 0 24 24" fill="none" shape-rendering="geometricPrecision">
